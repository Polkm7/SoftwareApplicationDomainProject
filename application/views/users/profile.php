...
?>
		<div class="container">
			<div class="jumbotron" >
				...
				<a class="btn btn-warning" href="<?=site_url('users/change/info');?>">Change Your Information</a>
				<a class="btn btn-danger" href="<?=site_url('users/change/password');?>">Change Your Password</a>
			</div>
